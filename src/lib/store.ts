...
const SEED_NOTES: Note[] = [
  ...
  {
    id: "seed-2",
    body: "Ghi chú số 2: Học Rust\n- Mục tiêu: App nhẹ\n- Chạy nền <50MB RAM\n- Chạy nền mong anywhere",
    x: 64,
    y: 10,
    rot: 1.5,
    tint: "sage",
  ...
  {
    id: "seed-3",
    body: "Welcome Note\nThis transparent, full screen desktop note. The cozy note can be placed anywhere with all transparent.\n\nWhile pet can move with you anywhere.",
    x: 36,
    y: 26,
    rot: 0,
    tint: "cream",
  ...
  {
    id: "seed-4",
    body: "Ghi chú số 3: Tối ưu UI\n- Màn hình trong suốt phủ toàn Desktop\n- Sắp xếp note nhanh bằng nút Arrange",
    x: 18,
    y: 46,
    rot: 2.1,
    tint: "mist",
  ...
  {
    id: "seed-5",
    body: "Ghi chú số 4: Pet Cáo nhỏ 🦊\n- Chạy nền <50MB RAM\n- Đi dạo quanh màn hình\n- Cho ăn và xoa đầu",
    x: 62,
    y: 52,
    rot: -2.2,
    tint: "blush",
